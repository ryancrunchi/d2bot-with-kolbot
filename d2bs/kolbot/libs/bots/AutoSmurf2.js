...
var Team = {
    size: 2 + Config.AutoSmurf2.Smurfs.length,
    ...
    init: function () {
        ...
        this.start = function () {
            ...
            if (me.windowtitle === Config.AutoSmurf2.Smurfette) {
                this.myType = this.type.smurfette;
            } else if (me.windowtitle === Config.AutoSmurf2.BigSmurf) {
    ...
    sendMsg: function (teamType, action, x, y, area) {
        ...
        this.sendTo = function (mode, msg) {
            if ((teamType & this.type.smurfette) !== 0) {
                sendCopyData(null, Config.AutoSmurf2.Smurfette, mode, msg);
            }
            if ((teamType & this.type.bigSmurf) !== 0) {
                sendCopyData(null, Config.AutoSmurf2.BigSmurf, mode, msg);
            }
            if ((teamType & this.type.smurf) !== 0) {
                for (i = this.size - 3; i >= 0; i -= 1) {
                    sendCopyData(null, Config.AutoSmurf2.Smurfs[i], mode, msg);
                }
            }
