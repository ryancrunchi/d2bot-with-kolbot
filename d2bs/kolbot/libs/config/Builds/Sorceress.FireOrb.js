...
var AutoBuildTemplate = {
	...
	1:	{	
		...
		Update: function () {
			...
			if (item && item.itemType == 26) {
				...
				item = Item.getEquippedItem(5).item;
				if (item && item.itemType == 26) {
					attack = 36; // At level 1 we start with a +1 Fire Bolt staff
				}
			}
	...
	StatPoints: [0, 0, 0, 0, 0],
		Update: function () {
			Config.AttackSkill = [-1,36,-1,36,-1,0,-1];
		}
	},
	...
	7:	{
		SkillPoints: [42,43], // static, telekinesis (den quest)
	...
	12:	{
		SkillPoints: [47, 50], // fireball, shiver armor
		StatPoints: [3, 3, 3, 3, 0],
		Update: function () {
			Config.BeltColumn = ["hp", "mp", "mp", "mp"];
			Config.AttackSkill = [-1,47,-1,47,-1,0,-1];
		}
	},
	...
	24:	{
		SkillPoints: [47,59], // fireball, blizzard (radament)
		StatPoints: [3, 3, 1, 1, 1],
		Update: function () {
	...
	30:	{
		SkillPoints: [64, 65, 61], // frozen orb, cold mastery, fire mastery (izual quest)
	...
	40:	{
		SkillPoints: [64, 64, 64], // izual quest
		StatPoints: [3, 3, 3, 3, 1],
		Update: function () {
	...
	64:	{
		SkillPoints: [36, 36, 36], // izual quest
		StatPoints: [3, 3, 3, 3, 1],
		Update: function () {
