...
function LoadConfig() {
	...
	*/
	...
	Config.CastStatic = 75; // Cast static until the target is at designated life percent. 100 = disabled.
	...
	Config.AutoBuild.Template = "FireOrb";	//	The name of the build associated with an existing 
    ...
    Scripts.AutoSmurf2 = false;
        Config.AutoSmurf2.Smurfette = "ASFireOrb";
