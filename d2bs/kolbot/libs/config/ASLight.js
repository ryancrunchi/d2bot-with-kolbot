...
function LoadConfig() {
	...
	*/
	...
	Config.QuitList = ["jouirjouissance"]; // List of character names to quit with. Example: Config.QuitList = ["MySorc", "MyDin"];
	...
	Config.PickRange = 25; // Pick radius
	...
	Config.SoldItemInfoQuality = [4, 5, 6, 7, 8]; // The quality of sold items to log
	...
	Config.RepairPercent = 10; // Durability percent of any equipped item that will trigger repairs.
	...
	Config.ScanShrines = [1,2,3,12,4,5,13,15,6,7,8,9,10,11,14,16,17,18,19,20,21,22];
	...
	Config.FHR = 142; // 0 - disable, 1 to 255 - set value of Faster Hit Recovery.
	...
	Config.StaticList = ["Andariel", "Duriel", "Mephisto", "Izual", "Diablo", "Baal"]; // List of monster NAMES or CLASSIDS to static. Example: Config.StaticList = ["Andariel", 243];
	...
	Scripts.AutoSmurf = true;
		Config.AutoSmurf.TeamSize = 2; //- length of your ingame team
		Config.AutoSmurf.TeleportingSorc = ["jouirjouissance", "jouirance", ""]; // ingame character(s) name(s) - ex: ["SorcTeleportA", "SorcTeleportB", ""];
			//- search brain - teleport to diablo/baal - if you have less than 3 sorc, use this - 3 characters max
		Config.AutoSmurf.QuestingSorcA = ["jouirjouissance", "", ""]; // ingame character(s) name(s) - ex: ["SorcFireBall", "", ""];
			//- search eye / rescue barbs - 3 characters max
		Config.AutoSmurf.QuestingSorcB = ["jouirance", "", ""]; // ingame character(s) name(s) - ex: ["SorcBlizzard", "", ""];
