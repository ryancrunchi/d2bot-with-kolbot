...
function LoadConfig() {
	...
	*/
	...
	Config.QuitList = ["ASBlizz"]; // List of character names to quit with. Example: Config.QuitList = ["MySorc", "MyDin"];
	...
	Config.ScanShrines = [1,2,3,12,4,15,6,7,8,9,10,11,14,16,17,18,19,20,21,22];
	...
	Config.AutoBuild.Template = "GFBarb";	//	The name of the build associated with an existing 
