...
function LoadConfig() {
	...
	Scripts.PowerRusher = true;
	Scripts.PowerRushee = false;
	...
	*/
	...
	Config.QuitList = ["Rushee"]; // List of character names to quit with. Example: Config.QuitList = ["MySorc", "MyDin"];
	...
	Scripts.AutoSmurf = false;
		...
		Config.AutoSmurf.BoBarb = "Chibarb";
		Config.AutoSmurf.NonSorcChar = [];
      	Config.AutoSmurf.AllTeamProfiles = ["ASBarb", "ASBlizz"];
    ...
    Scripts.AutoSmurf2 = false;
        ...
        Config.AutoSmurf2.BigSmurf = "ASBarb";
