...
function LoadConfig() {
	...
	*/
	...
	Config.Leader = "Chibradin"; // Leader's ingame character name. Leave blank to try auto-detection (works in AutoBaal, Wakka, MFHelper)
	...
	Config.UseMercHP = 25; // Give a healing potion to your merc if his/her life is under designated percent.
	...
	Config.PingQuit = [{Ping: 1000, Duration: 20}]; // Quit if ping is over the given value for over the given time period in seconds.
	 ...
	 */
	Config.AttackSkill[0] = 245; // Preattack skill.
