...
function LoadConfig() {
	...
	*/
	...
	// 	Config.KeepRunewords.push("[type] == auricshields # [fcr] >= 25"); // Pala shield spirit for bo
		Config.KeepRunewords.push("[type] == shield || [type] == auricshields || [type] == sword # [fcr] >= 25"); // Any Spirit
	...
	Config.StaticList = ["Lord De Seis", "Nihlathak", "The Countess", "Andariel", "Duriel", "Mephisto", "Izual", "Diablo", "Baal"]; // List of monster NAMES or CLASSIDS to static. Example: Config.StaticList = ["Andariel", 243];
